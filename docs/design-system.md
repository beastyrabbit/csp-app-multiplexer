...
| **CSP Mux** | `C:/projects/csp-app-multiplexer` | WinForms → **WPF**, `net10.0-windows` | Rewritten |
...
| `CspMultiplexer.Broker`, `CspMultiplexer.Protocol` | **Untouched.** `net10.0`, UI-agnostic. |
